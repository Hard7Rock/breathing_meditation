...
export default function CoherentBreathing() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900 flex flex-col dark:from-indigo-900 via-blue-900 to-purple-900 flex flex-col light:from-blue-100 light:via-purple-100 light:to-pink-100 transition-colors duration-500">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-white/80 dark:text-white/80 light:text-gray-700 text-lg">Когерентне Дихання</p>
        </motion.div>
