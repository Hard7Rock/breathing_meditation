...
export default function BoxBreathing() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-900 via-teal-900 to-emerald-900 flex flex-col dark:from-green-900 via-teal-900 to-emerald-900 flex flex-col transition-colors duration-500">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-white/80 dark:text-white/80 text-lg">Квадратне Дихання</p>
        </motion.div>
