...
export default function FourSevenEight() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 dark:from-blue-900 dark:via-purple-900 dark:to-indigo-900 transition-colors duration-500 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-white/80 dark:text-white/80 text-lg">Relaxing Breath</p>
        </motion.div>
        ...
        <div className="flex gap-4">
          {!isActive ? (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handleStart}
              className="px-8 py-4 bg-white dark:bg-white text-purple-900 dark:text-purple-900 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-shadow"
            >
              Почати
            </motion.button>
          ) : (
