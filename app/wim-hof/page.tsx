...
export default function WimHof() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-orange-900 via-red-900 to-amber-900 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-white/80 text-lg">Метод Віма Хофа</p>
        </motion.div>
